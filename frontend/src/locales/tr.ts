...
export const tr = {
  ...
  home: {
    ...
    noGroups: 'Henüz bir grubunuz yok',
    noGroupsContact: 'Harcamalarınızı takip etmek için bir grup oluşturun veya davet bekleyin.',
    createFirstGroup: 'İlk Grubunuzu Oluşturun',
    createAnotherGroup: '+ Başka Grup Oluştur',
    createNewGroupTitle: 'Yeni Grup Oluştur',
    groupNameLabel: 'Grup Adı',
    groupNameRequired: 'Grup Adı *',
    groupNamePlaceholder: 'örn., Aile Bütçesi, Ev Arkadaşları, Avrupa Gezisi',
    descriptionLabel: 'Açıklama (isteğe bağlı)',
    descriptionPlaceholder: 'Bu grup ne için kullanılacak?',
